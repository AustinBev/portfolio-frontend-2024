...
const Projects: Project[] = [
    {
        ...
        backendUrl: 'https://github.com/BrownTroutCoding/Yeonjii_Backend.git',
        frontendUrl: 'https://github.com/mruthai/yeonjii_frontend.git',
    ...
    },
    {
        ...
        description: "A fly fishing web app where users can check river conditions, save favorite locations, and sign up/in with Google authentication. The home page offers quick information through the USGS API for checking river flow and temperatures before planning a fishing trip. Site is live but the google login and database operations have been suspended due to high maintenance costs.",
